...
const allPriorityColors = document.querySelectorAll('.priority')
const textAreaCont = document.querySelector('.textArea-cont')
const mainCont = document.querySelector('.main-cont')
const toolboxColors = document.querySelectorAll('.filter')
const colors = ['color-lightpink', 'color-lightgreen', 'color-lightblue', 'color-black']
const lockIconClass = 'fa-lock'
const unlockIconClass = 'fa-lock-open'
let addTaskFlag = false
let removeTaskFlag = false
let modalPriorityColor = 'color-lightpink'
let ticketArray = []
